...
![Estação de reabastecimento](/Etapa-01-Logica/Estacao_H2.png)
...
| ---------------- | ----------------------- | ------------------------------------ | ------------------ | ---------------------------------------------------------------------- |
| **PT-101**       | Transmissor Pressão     | Pressão do Banco de Armazenamento    | $p\_1$              | Pressão excede o limite máximo de armazenamento ($P > 900\text{ bar}$) |
| **TT-101**       | Transmissor Temp.       | Temp. do Banco de Armazenamento      | $t\_1$              | Temperatura excede o limite seguro do vaso ($T > 85^\circ\text{C}$)    |
| **AT-101**       | Detector de Gás H₂      | Concentração de H₂ na área           | $g\_1$              | Vazamento de hidrogênio detectado ($C > 1\text{% vol, } 25\text{% LIE}$) |
| **ESD-100**      | Botão Físico            | Segurança Manual                     | $e\_1$              | Parada de emergência acionada pelo operador                            |
| **XV-101**       | Válvula Corte Rápido    | Saída do Banco de Armazenamento      | $v\_1$              | Válvula de segurança de saída ABERTA                                   |
